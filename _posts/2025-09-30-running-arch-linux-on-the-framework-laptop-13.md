...
cd "$PKG_ROOT/Build"
export GITREPOS="adwaita-qt-git aic94xx-firmware akku alsacap alsa-hdspeconf amiberry amitools android-studio ansible-language-server aseprite asm-lsp ast-firmware astrojs-language-server astrojs-ts-plugin audacious-gtk3 audacious-plugins-gtk3 aurutils awk-language-server azahar-git basiliskii-git battop-bin blastem-hg bluez-hcitool bochs bottles brscan4 bundletool calibre-plugin-dedrm cdesktopenv-git chez-scheme claude-code clojure-lsp-bin cmake-format cmake-language-server codechecker conan cpp-jwt crush cubeb davinci-resolve debtap dev-proxy-bin diagnostic-languageserver displaylink dolphin-emu-git dosbox-x-git dotool dumpasn1 eclipse-platform eden-git elp evcxr_jupyter evdi-dkms-git exercism expert-git figma-linux-bin flow-bin flutterup flycast-git fsautocomplete-bin fuse-emulator fvs2 game-devices-udev ghcup-hs-bin gnome-shell-extension-dash-to-dock-git gnome-shell-extension-stealmyfocus-git gnome-shell-extension-tiling-shell-git google-cloud-cli google-earth-pro gopher64-git groovy-language-server-git gtk2 helm-ls ibmcloud-cli icaclient imhex infer-bin jdk25-graalvm-bin jdk25-openj9-bin jdtls kotlin-lsp-bin kubelogin lagrange leanux lemminx libbacktrace-git libchdr-git libpng12 libretro-beetle-cygne-git libretro-beetle-lynx-git libretro-beetle-ngp-git libretro-beetle-pcfx-git libretro-beetle-saturn-git libretro-bluemsx-git libretro-dosbox-pure-git libretro-fuse-git libretro-lrps2-git libretro-swanstation-git libretro-uae-git libretro-vice-git libspectrum libspng-git libwireplumber-4.0-compat license-wtfpl linux-tachyon llama.cpp-vulkan-git logisim-evolution-bin marksman-git marsdev-git mednaffe mei-amt-check-git metals mingw-w64-crt-msvcrt mingw-w64-gcc-msvcrt mingw-w64-headers-msvcrt mistral-vibe mkinitcpio-firmware mksh mongodb-bin mongosh-bin moonlight-qt-git ms-sys nbdkit ncurses5-compat-libs neo4j-community neovim-symlinks nestopia netcoredbg networkmanager-iwd nvidia-patch-git ocenaudio-bin omnisharp-roslyn-bin openmsx openshift-client-bin openshift-developer-bin openshift-pipelines-bin opentelemetry-python-contrib openvpn-update-systemd-resolved pandoc-bin papirus-folders passmark-performancetest-bin patool pcsx2-git pcsx-redux-git pegasus-frontend-git perlnavigator pi plutosvg plutovg postman-bin powercap powershell-bin powershell-editor-services pragmatapro-fonts prettier-plugin-xml protonplus protontricks-git ps3-disc-dumper-bin pupdate-bin pvsneslib-git pwvucontrol python-agent-client-protocol python-async-timeout python-backoff python-fvs python-gguf-git python-httpx-sse python-jsonpath-python python-m3u8 python-machine68k python-mistralai python-mkl python-opencensus python-orjson-git python-pathvalidate python-pluginbase python-pyqtdarktheme-fork python-pysdl2 python-python-ffmpeg python-setuptools-reproducible python-sounddevice python-steamgriddb python-tokenizers python-transformers python-tree-sitter python-tree-sitter-bash python-uuid7 python-uv-dynamic-versioning qt5-gamepad qt5-location qt5-webchannel qt5-webengine qt5-websockets rabtap rapidyaml rar razer-cli rcu-bin regionset retro68-git rpcs3-git ruby-backport ruby-commander ruby-dry-core ruby-dry-inflector ruby-dry-logic ruby-dry-types ruby-e2mmap ruby-highline ruby-jaro_winkler ruby-jekyll-include-cache ruby-jekyll-redirect-from ruby-jekyll-sitemap ruby-just-the-docs ruby-parlour ruby-reverse_markdown ruby-rubocop-yard ruby-solargraph ruby-sord ruby-yard-activesupport-concern ruby-yard-solargraph rusty-psn-bin ryujinx-git sameboy sbom-tool-bin scala-dotty scheme-langserver-bin sedutil sentencepiece sheepshaver-git shellcheck-bin sigtop-git skyscraper-git snd-hdspe-dkms-git soapui softhsm-git stc-syncthing-git sunshine-git svelte-language-server-git swift-bin systemd-suspend-modules tidal-dl-ng tla-toolbox townsemu-git ttf-b612 ttf-ms-win11-base ungoogled-chromium upd72020x-fw usbtop uxplay v4l-utils-git vacuum vala-language-server vasm ventoy visual-studio-code-bin vita3k-git vkbasalt-cli vlink vmware-keymaps vmware-workstation vtsls vulkan-memory-allocator wd719x-firmware winetricks-git winexe witr xcursor-dmz xdg-terminal-exec-git xpadneo-dkms yaml-language-server-git y-cruncher ymir-emu-git zeal-git"
