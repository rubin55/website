...
cd "$PKG_ROOT/Build"
export GITREPOS="ida-pro lib32-intel-gmmlib lib32-intel-media-driver llama.cpp-cuda-git nand2tetris openshift-codeready-bin wolfram"
