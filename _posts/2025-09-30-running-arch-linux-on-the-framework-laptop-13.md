...
```bash
pacman -S --needed acpi acpica acpi_call-dkms acpid alacritty alsa-firmware alsa-tools alsa-ucm-conf alsa-utils ansible-lint ant antlr4 ardour ares-emu aribb25 arj autoconf automake aws-cli base-devel bash bash-language-server bc bear bind biome bison blender bluez-tools bower btop bubblewrap bun busted bustle calibre cameractrls carla cdemu-client cdemu-daemon cdrdao cdrtools chawan chntpw cifs-utils clang clinfo clojure cmake corkscrew cpio cppcheck cpupower ctags cue cups curl dash dconf-editor dcraw ddcutil debugedit delve deno desmume devtools direnv distrobox dive dmidecode dmraid dnsmasq docker docker-buildx docker-compose dockerfile-language-server dool dos2unix dosfstools doxygen drawio-desktop d-spy dvd+rw-tools dvisvgm editorconfig-checker editorconfig-core-c efibootmgr elixir emacs-wayland erlang eslint eslint-language-server ethtool evolution-data-server exfatprogs extra-cmake-modules fakeroot fastfetch fd fdupes file file-roller fio firefox flex fltk1.3 fontforge foomatic-db-engine foomatic-db-nonfree-ppds foomatic-db-ppds fractal freecad freetype2-demos fs-uae fs-uae-launcher furnace fwupd fzf gamemode gamescope gcc gdb gdm ghidra gimp git git-filter-repo github-cli git-lfs glab gnome-backgrounds gnome-browser-connector gnome-calculator gnome-characters gnome-control-center gnome-disk-utility gnome-font-viewer gnome-logs gnome-session gnome-settings-daemon gnome-shell gnome-shell-extension-appindicator gnome-shell-extension-desktop-icons-ng gnome-shell-extensions gnome-system-monitor gnome-themes-extra gnome-tweaks gnupg gnuplot go gopls go-tools gparted gperf gradle groovy gtksourceview3 gtkwave guile gvfs gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-smb handbrake harfbuzz-cairo hdparm helix helm hplip htop hunspell hunspell-de hunspell-en_gb hunspell-en_us hunspell-es_es hunspell-fr hunspell-nl i2c-tools ifuse img2pdf inetutils inkscape iperf3 iptables-nft irssi iverilog iwd jekyll jfsutils jq jupyterlab jupyterlab-lsp jupyter-lsp jupyter-notebook just k9s kafka kddockwidgets kotlin ktlint kubeconform kubectl kubeseal leiningen lhasa libblockdev-crypto libblockdev-dm libblockdev-fs libblockdev-loop libblockdev-lvm libblockdev-mdraid libblockdev-mpath libblockdev-nvme libblockdev-part libblockdev-swap libebur128 libgoom2 libicns libindicator-gtk3 librashader librecad libreoffice-still libretro-beetle-pce libretro-beetle-psx-hw libretro-blastem libretro-core-info libretro-desmume libretro-dolphin libretro-flycast libretro-mame libretro-mgba libretro-mupen64plus-next libretro-nestopia libretro-picodrive libretro-ppsspp libretro-sameboy libretro-scummvm libretro-snes9x libtiger libva-mesa-driver libva-utils libvirt libwebp-utils libxcrypt-compat linux-firmware-bnx2x linux-firmware-liquidio linux-firmware-mellanox linux-firmware-nfp linux-firmware-qlogic linux-headers live-media lld lldb lm_sensors loupe lshw lsof lsscsi ltrace lua-language-server make mame mame-tools man-db mangohud man-pages markdownlint-cli mattermost-desktop maven mednafen mesa-demos mesa-utils meson mgba-qt minikube mitmproxy mono mono-msbuild moreutils mpv msr-tools mtools multipath-tools mupdf-tools mutter nasm nautilus nbd neovide neovim netbeans networkmanager-openvpn networkmanager-vpn-plugin-openvpn net-tools nfs-utils ninja nmap nodejs noto-fonts-emoji npm ntfs-3g nuget nvchecker nvme-cli nvtop openai-codex openbsd-netcat opencl-clhpp opencl-headers opencode openldap openssh openvpn osv-scanner p7zip pacman-contrib pacutils papers papirus-icon-theme patch patchelf pciutils pdfarranger perf perl perl-lwp-protocol-https perl-net-dbus perl-x11-protocol perl-yaml pinentry pipewire pipewire-alsa pipewire-jack pipewire-libcamera pipewire-pulse pipewire-v4l2 pkgconf postgresql powertop ppsspp prettier projectm protonmail-bridge psutils python python-pygobject-stubs python-huggingface-hub python-jsbeautifier python-jwcrypto python-kubernetes python-ldap python-lsp-server python-netaddr python-nose python-numpy python-opengl python-patch-ng python-pip python-psutil python-pycryptodomex python-pylint python-pyopenssl python-pytest python-rope python-safetensors python-setuptools python-sphinx python-sphinx-autobuild python-sympy python-websockets python-wheel qbittorrent qjackctl qpwgraph qsynth qt5ct qt5-declarative qt5-tools qt5-wayland qt6ct qt6-multimedia-ffmpeg qt6-tools qt6-wayland quodlibet rabbitmq racket ranger realtime-privileges rebar3 rebuild-detector recode retroarch retroarch-assets-glui retroarch-assets-ozone ripgrep rlwrap rsync rtkit ruby ruby-base64 ruby-bigdecimal ruby-csv ruby-default-gems ruby-irb ruby-rake-compiler rustup samba sane sbt scons screen scummvm sdcc sdl2_mixer seahorse seatd sentry-cli shfmt signal-desktop simple-scan smartmontools smbclient snapshot snes9x-gtk sof-firmware sox speedtest-cli squashfs-tools steam step-ca step-cli stern strace s-tui sudo syncthing sysdig sysprof sysstat tailwindcss-language-server taplo-cli tar terminus-font texinfo texlab texlive-basic texlive-bin texlive-fontsrecommended texlive-latex texlive-latexextra texlive-latexrecommended texlive-pictures the_silver_searcher thunderbird tidy tinyxxd tmux tokei traceroute tracker3-miners tree tree-sitter-cli ttf-ibm-plex ttf-nerd-fonts-symbols-mono ttf-ubuntu-font-family turbostat twine typescript typescript-language-server udftools udisks2-lvm2 unarchiver uncrustify unixodbc unzip urlwatch usbutils util-linux uucp valgrind valkey vdpauinfo vhba-module-dkms vice-sdl2 vkd3d vscode-css-languageserver vscode-html-languageserver vscode-json-languageserver vue-language-server vulkan-tools w3m wavemon wayland-utils wgetpaste whois wimlib wine wine-mono wireless-regdb wireless_tools wireplumber wireshark-cli wireshark-qt wl-clipboard wmctrl wol xcb-util-errors xchm xclip xdelta3 xdg-desktop-portal-gnome xdg-user-dirs-gtk xdg-utils xdotool xfsprogs xmlstarlet xorg-fonts-100dpi xorg-fonts-misc xorg-font-util xorg-mkfontscale xorg-server xorg-server-devel xorg-xauth xorg-xdpyinfo xorg-xdriinfo xorg-xev xorg-xfontsel xorg-xhost xorg-xinit xorg-xinput xorg-xkill xorg-xlsclients xorg-xprop xorg-xrandr xorg-xrdb xorg-xset xorg-xsetroot xorg-xvinfo xorg-xwayland xorg-xwininfo yarn yasm yq yt-dlp zig zip zk zls zstd
```
...
```bash
pacman -S --needed gst-plugin-va intel-compute-runtime intel-gpu-tools intel-graphics-compiler intel-media-driver libvdpau-va-gl opencv python-opencv python-pytorch-opt vulkan-intel clpeak
```

Also, from my [own package repositories on Codeberg][1], I install `lib32`
variants of the intel driver:
...
```bash
pacman -S --needed radeontop vulkan-radeon gst-plugin-va opencv python-opencv python-pytorch-opt-rocm clpeak
```
...
```bash
pacman -S --needed cuda ffnvcodec-headers libva-nvidia-driver nvidia-cg-toolkit nvidia-settings nvidia-utils nvidia-open-dkms nvtop opencl-nvidia openssl-1.1 gst-plugins-bad python-pytorch-opt-cuda opencv-cuda python-opencv-cuda nsight-compute nsight-systems clpeak-cuda
```
...
### Additionally install if you have a Razer device

Razer mice and keyboards have all kinds of options that you don't have access
to without installing additional software. In my case, I have an ancient Razer
Imperator 2012 for which I want to set the DPI, so I install the following:

```bash
pacman -S openrazer-daemon
```

Then we need to add our user to the `openrazer` group:

```bash
gpasswd -a "$USER" openrazer
```

Finally, you'd need to install a front-end. There are various options for that;
I prefer `razer-cli` which I install from AUR.
...
# For llama.cpp-cuda-git, llama.cpp-vulkan-git:
aur_llamacpp_build_universal=true
...
cd "$PKG_ROOT/Build"
export GITREPOS="adwaita-qt-git aic94xx-firmware akku almond alsacap alsa-hdspeconf amiberry amitools android-studio ansible-language-server aseprite asm-lsp ast-firmware astrojs-language-server astrojs-ts-plugin audacious-gtk3 audacious-plugins-gtk3 aurutils awk-language-server azahar-git basiliskii-git blastem-hg bluez-hcitool bochs bottles brscan4 bundletool calibre-plugin-dedrm cdesktopenv-git chez-scheme claude-code clojure-lsp-bin cmake-format cmake-language-server codechecker computer-use-linux conan coursier cpp-jwt cubeb davinci-resolve debtap dev-proxy diagnostic-languageserver displaylink dolphin-emu-git dosbox-x-git dotool dumpasn1 eclipse-platform eden-git elp evcxr_jupyter evdi-dkms-git exercism expert-git figma-linux-bin flow-bin flutterup flycast-git font-symbola fsautocomplete fuse-emulator fvs2 game-devices-udev gemrb ghcup-hs-bin gnome-shell-extension-dash-to-dock-git gnome-shell-extension-stealmyfocus-git gnome-shell-extension-tiling-shell-git google-cloud-cli google-earth-pro gopher64-git groovy-language-server-git gtk2 helm-ls ibmcloud-cli imhex infer-bin jdk25-graalvm-bin jdk25-openj9-bin jdtls jira-cli kotlin-lsp-bin kubelogin lagrange leanux lemminx libbacktrace-git libchdr-git libpng12 libretro-beetle-cygne-git libretro-beetle-lynx-git libretro-beetle-ngp-git libretro-beetle-pcfx-git libretro-beetle-saturn-git libretro-bluemsx-git libretro-dosbox-pure-git libretro-fuse-git libretro-lrps2-git libretro-swanstation-git libretro-uae-git libretro-vice-git libspectrum libspng-git libwireplumber-4.0-compat license-wtfpl linux-tachyon logisim-evolution marksman-git marsdev-git mednaffe mei-amt-check-git metals mingw-w64-crt-msvcrt mingw-w64-gcc-msvcrt mingw-w64-headers-msvcrt mkinitcpio-firmware mksh mongodb-bin mongosh-bin moonlight-qt-git ms-sys nbdkit ncurses5-compat-libs neo4j-community neovim-symlinks nestopia netcoredbg networkmanager-iwd nvidia-patch-git nvim-mcp-git ocenaudio-bin openmsx openshift-client-bin openshift-developer-bin openshift-pipelines-bin opentelemetry-python-contrib openvpn-update-systemd-resolved pandoc-bin papirus-folders passmark-performancetest-bin patool pcsx2-git pcsx-redux-git pegasus-frontend-git perlnavigator plutosvg plutovg postman-bin powercap powershell powershell-editor-services pragmatapro-fonts prettier-plugin-xml protonplus protontricks-git ps3-disc-dumper pupdate pvsneslib-git pwvucontrol python-async-timeout python-backoff python-fvs python-gguf-git python-m3u8 python-machine68k python-mkl python-opencensus python-orjson-git python-pathvalidate python-pluginbase python-pyqtdarktheme-fork python-pysdl2 python-python-ffmpeg python-setuptools-reproducible python-steamgriddb python-tokenizers python-transformers python-uuid7 qadwaitadecorations-git qt5-gamepad qt5-location qt5-webchannel qt5-webengine qt5-websockets rabtap rapidyaml rar razer-cli rcu-bin regionset retro68-git roslyn-language-server rpcs3-git ruby-backport ruby-commander ruby-e2mmap ruby-jaro_winkler ruby-jekyll-include-cache ruby-jekyll-redirect-from ruby-jekyll-sitemap ruby-just-the-docs ruby-parlour ruby-reverse_markdown ruby-rubocop-yard ruby-solargraph ruby-sord ruby-yard-activesupport-concern ruby-yard-solargraph rusty-psn ryujinx-git sameboy sbom-tool scala-dotty scheme-langserver sedutil sentencepiece sheepshaver-git shellcheck-bin sigtop-git skyscraper-git snd-hdspe-dkms-git soapui softhsm-git sonarqube-cli stc-syncthing-git sunshine-git svelte-language-server-git swift-bin systemd-suspend-modules tidal-dl-ng tla-toolbox townsemu-git ttf-b612 ttf-ms-win11-base ungoogled-chromium upd72020x-fw usbtop uxplay v4l-utils-git vacuum vala-language-server vasm ventoy visual-studio-code-bin vita3k-git vkbasalt-cli vlink vmware-keymaps vmware-workstation vtsls vulkan-memory-allocator wd719x-firmware winetricks-git winexe witr xcursor-dmz xdg-terminal-exec-git xpadneo-dkms yaml-language-server-git y-cruncher ymir-emu-git zeal-git"
...
cd "$PKG_ROOT/Build"
export GITREPOS="ida-pro lib32-intel-gmmlib lib32-intel-media-driver llama.cpp-cuda-git llama.cpp-vulkan-git nand2tetris openshift-codeready-bin wolfram"
...
I maintain these packages on AUR:

  * [cdesktopenv-git](https://aur.archlinux.org/packages/cdesktopenv-git)
  * [computer-use-linux](https://aur.archlinux.org/packages/computer-use-linux)
  * [dev-proxy](https://aur.archlinux.org/packages/dev-proxy)
  * [fsautocomplete](https://aur.archlinux.org/packages/fsautocomplete)
  * [ghcup-hs-bin](https://aur.archlinux.org/packages/ghcup-hs-bin)
  ...
  * [llama.cpp-vulkan-git](https://aur.archlinux.org/packages/llama.cpp-vulkan-git)
  * [marksman-git](https://aur.archlinux.org/packages/marksman-git)
  * [marsdev-git](https://aur.archlinux.org/packages/marsdev-git)
  * [nvim-mcp-git](https://aur.archlinux.org/packages/nvim-mcp-git)
  ...
  * [pupdate](https://aur.archlinux.org/packages/pupdate)
  ...
  * [ruby-commander](https://aur.archlinux.org/packages/ruby-commander)
  * [ruby-parlour](https://aur.archlinux.org/packages/ruby-parlour)
  * [ruby-rubocop-yard](https://aur.archlinux.org/packages/ruby-rubocop-yard)
  * [ruby-solargraph](https://aur.archlinux.org/packages/ruby-solargraph)
  * [ruby-sord](https://aur.archlinux.org/packages/ruby-sord)
  ...
  * [sbom-tool](https://aur.archlinux.org/packages/sbom-tool)
  * [scheme-langserver](https://aur.archlinux.org/packages/scheme-langserver)
  * [sonarqube-cli](https://aur.archlinux.org/packages/sonarqube-cli)
  ...
  * [winexe](https://aur.archlinux.org/packages/winexe)
...
I maintain these packages on Codeberg:
  ...
  * [llama.cpp-cuda-git](https://codeberg.org/rubin/llama.cpp-cuda-git)
  * [llama.cpp-vulkan-git](https://codeberg.org/rubin/llama.cpp-vulkan-git)
...
These are a few open source softwares I still want to create packages for:

  * [apache-artemis](https://artemis.apache.org/)
  * [vbcc](http://www.compilers.de/vbcc.html)

And I also want to create packages for these commercial packages: 
