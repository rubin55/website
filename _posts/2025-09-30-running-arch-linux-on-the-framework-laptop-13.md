...
cd "$PKG_ROOT/Build"
export GITREPOS="ida-pro intel-oneapi-base-toolkit intel-openvino lib32-intel-gmmlib lib32-intel-media-driver llama.cpp-cuda-git llama.cpp-sycl-git nand2tetris openshift-codeready-bin wolfram"
