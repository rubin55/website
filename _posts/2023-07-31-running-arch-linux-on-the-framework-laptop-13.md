...
I maintain these packages (all on AUR, except for `openshift-codeready-bin`):
  ...
  * [gnome-shell-extension-fullscreen-to-new-workspace-git](https://aur.archlinux.org/packages/gnome-shell-extension-fullscreen-to-new-workspace-git)
